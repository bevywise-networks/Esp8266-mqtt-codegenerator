...
public class CodeGenForESP8266 { 
	...
	public static void main(String[] args) {
		...
		try { 
			...
			esp.setDeviceAuthentication(esp.getValueFromCommandLine("Enter MQTT Device Username for Authentication (Mandatory):"), esp.getValueFromCommandLine("Enter MQTT Device Password for Authentication (Mandatory):"));
			...
			for( int i = 0 ; i < count ; i++) {
				datatype[i] = esp.getValueFromCommandLine("Enter Data type for the parameter "+ (i+1) +": ( int , float, boolean , String)");
